-- CREATE DATABASE FOR /home/centos/orm_synthesizer/models/hospital_mgmt_extended/ImplSolution/hospital_mgmt_extended_Sol_17116.sql

USE hospital_mgmt_extended_Sol_17116;
--
...
KEY `FK_Patient_HMSId_idx` (`HMSId`),
...
KEY `FK_Ward_DoctorId_idx` (`DoctorId`),
...
`StaffId` int NOT NULL, 
KEY `FK_LabAssistant_StaffId_idx` (`StaffId`),
PRIMARY KEY (`StaffId`)
);
...
ALTER TABLE `Patient`
  ADD CONSTRAINT `FK_Patient_HMSId` FOREIGN KEY (`HMSId`) REFERENCES `HospitalManagementSystem` (`HMSId`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `Ward`
  ...
  ADD CONSTRAINT `FK_Ward_DoctorId` FOREIGN KEY (`DoctorId`) REFERENCES `Doctor` (`DoctorId`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `LabAssistant`
  ADD CONSTRAINT `FK_LabAssistant_StaffId` FOREIGN KEY (`StaffId`) REFERENCES `Staff` (`StaffId`) ON DELETE CASCADE ON UPDATE CASCADE;
