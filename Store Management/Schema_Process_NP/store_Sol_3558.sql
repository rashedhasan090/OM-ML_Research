-- CREATE DATABASE FOR /home/centos/orm_synthesizer/models/store/ImplSolution/store_Sol_3558.sql
...
KEY `FK_Stock_StoreDbId_idx` (`StoreDbId`),
PRIMARY KEY (`StockId`)
);
...
ALTER TABLE `Stock`
  ...
  ADD CONSTRAINT `FK_Stock_StoreDbId` FOREIGN KEY (`StoreDbId`) REFERENCES `StoreDatabase` (`StoreDbId`) ON DELETE CASCADE ON UPDATE CASCADE;
