...
import os
i = 0
for root, dirs, files in os.walk('/Users/rashedhasan/Desktop/UNL/Research/Object relational mapping/Step 5 - Abstraction/OM-Solution_Mapping/OM-ML_Research/Library Management/Processing Solutions/SQL_soln_process_P'):
    for file in files:
        #each file
