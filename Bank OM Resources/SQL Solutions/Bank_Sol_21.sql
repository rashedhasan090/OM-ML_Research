-- CREATE DATABASE FOR /home/centos/orm_synthesizer/models/Bank/ImplSolution/Bank_Sol_21.sql
...
ALTER TABLE `Account`
  ADD CONSTRAINT `FK_Account_CustomerId` FOREIGN KEY (`CustomerId`) REFERENCES `Customer` (`CustomerId`) ON DELETE CASCADE ON UPDATE CASCADE;
