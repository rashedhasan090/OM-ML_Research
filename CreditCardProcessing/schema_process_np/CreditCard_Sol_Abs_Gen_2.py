...
import os
i = 0
for root, dirs, files in os.walk('/Users/rashedhasan/Desktop/UNL/Research/Object relational mapping/Step 5 - Abstraction/OM-Solution_Mapping/OM-ML_Research/CreditCardProcessing/schema_process_np'):
    for file in files:
        #each file
        ...
        if extension == '.sql':
            ...
            #-----------------------------------------------------------------------------
                ...
                if f'`{c8_at1}` {c8_at1_type}(64),' in mylist[j]:
                    mylist[j] = (f"`{c8_at1_0}` {c8_at1_type_0}(64),")
                    a314 = mylist[j]
            ...
            #   -------------------------------------------------------------------------------
             ...
             # ------------ ----------------- ------------- -  - --- ----
                ...
                if f'{c5_at1}` {c5_at1_type}(64),' in mylist[j]:
                    mylist[j] = (f"{c5_at1_0}` {c5_at1_type_0}(64),")
                    a419= mylist[j]
                ...
                if f'`{c2_at1}` int NOT NULL,' in mylist[j]:
                    mylist[j] = (f"`{c2_at1_0}` int NOT NULL,")
                    a421= mylist[j]
                    file_object.write(a421)
                    file_object.write("\n")
                ...
                if f'KEY `FK_{assoc10}_{c1_at1}_idx` (`{c1_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc10_0}_{c1_at1_0}_idx` (`{c1_at1_0}`),")
                    a424= mylist[j]
                ...
                if f'ADD CONSTRAINT `FK_{assoc10}_{c1_at1}` FOREIGN KEY (`{c1_at1}`) REFERENCES `{class1_name}` (`{c1_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{assoc10_0}_{c1_at1_0}` FOREIGN KEY (`{c1_at1_0}`) REFERENCES `{class1_name_0}` (`{c1_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a427= mylist[j]
                ...
                if f'ADD CONSTRAINT `FK_{class3_name}_{c8_at1}` FOREIGN KEY (`{c8_at1}`) REFERENCES `{class8_name}` (`{c8_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{class3_name}_{c8_at1}` FOREIGN KEY (`{c8_at1_0}`) REFERENCES `{class8_name_0}` (`{c8_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a428= mylist[j]
                    file_object.write(a428)
                    file_object.write("\n")
                ...
                if f'KEY `FK_{assoc9}_{c3_at1}_idx` (`{c3_at1}`)' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc9_0}_{c3_at1_0}_idx` (`{c3_at1_0}`)")
                    a429= mylist[j]
                    file_object.write(a429)
                    file_object.write("\n")


                if f'KEY `FK_{assoc9}_{c2_at1}_idx` (`{c2_at1}`)' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc9_0}_{c2_at1_0}_idx` (`{c2_at1_0}`)")
                    a430= mylist[j]
                    file_object.write(a430)
                    file_object.write("\n")


                if f'CREATE TABLE `{c9_at1}` (' in mylist[j]:
                    mylist[j] = (f"CREATE TABLE `{c9_at1_0}` (")
                    a431= mylist[j]
                    file_object.write(a431)
                    file_object.write("\n")


                if f'`{c9_at1}` {c9_at1_type}(64),' in mylist[j]:
                    mylist[j] = (f"`{c9_at1_0}` {c9_at1_type_0}(64),")
                    a432= mylist[j]
                ...
                if f'KEY `FK_{class9_name}_{c2_at1}_idx` (`{c2_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{class9_name_0}_{c2_at1_0}_idx` (`{c2_at1_0}`),")
                    a433= mylist[j]
                    file_object.write(a433)
                    file_object.write("\n")

                if f'{c10_at1}` {c10_at1_type}' in mylist[j]:
                    mylist[j] = (f"{c10_at1_0}` {c10_at1_type_0}")
                    a434= mylist[j]
                    file_object.write(a434)
                    file_object.write("\n")


                if f'KEY `FK_{class2_name}_{c10_at1}_idx` (`{c10_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{class2_name_0}_{c10_at1_0}_idx` (`{c10_at1_0}`),")
                    a435= mylist[j]
                    file_object.write(a435)
                    file_object.write("\n")

                if f'KEY `FK_{class3_name}_{c10_at1}_idx` (`{c10_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{class3_name_0}_{c10_at1_0}_idx` (`{c10_at1_0}`),")
                    a436= mylist[j]
                ...
                if f'KEY `FK_{assoc7}_{c1_at1}_idx` (`{c1_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc7_0}_{c1_at1_0}_idx` (`{c1_at1_0}`),")
                    a438= mylist[j]
                    file_object.write(a438)
                    file_object.write("\n")


                if f'KEY `FK_{assoc1}_{c4_at3}_idx` (`{c4_at3}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc1_0}_{c4_at3_0}_idx` (`{c4_at3_0}`),")
                    a439= mylist[j]
                    file_object.write(a439)
                    file_object.write("\n")


                if f'KEY `FK_{assoc4}_{c10_at1}_idx` (`{c10_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc4_0}_{c10_at1_0}_idx` (`{c10_at1_0}`),")
                    a439= mylist[j]
                    file_object.write(a439)
                    file_object.write("\n")

                if f'KEY `FK_{assoc4}_{c6_at2}_idx` (`{c6_at2}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc4_0}_{c6_at2_0}_idx` (`{c6_at2_0}`),")
                    a440= mylist[j]
                    file_object.write(a440)
                    file_object.write("\n")


                if f'PRIMARY KEY (`{c10_at1}`,`{c6_at2}`)' in mylist[j]:
                    mylist[j] = (f"PRIMARY KEY (`{c10_at1_0}`,`{c6_at2_0}`)")
                    a441= mylist[j]
                    file_object.write(a441)
                    file_object.write("\n")

                if f'KEY `FK_{assoc5}_{c1_at1}_idx` (`{c1_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc5_0}_{c1_at1_0}_idx` (`{c1_at1_0}`),")
                    a442= mylist[j]
                    file_object.write(a442)
                    file_object.write("\n")


                if f'KEY `FK_{assoc6}_{c4_at3}_idx` (`{c4_at3}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc6_0}_{c4_at3_0}_idx` (`{c4_at3_0}`),'")
                    a443= mylist[j]
                ...
                if f'`{c10_at2}` {c10_at2_type}(64),' in mylist[j]:
                    mylist[j] = (f"`{c10_at2_0}` {c10_at2_type_0}(64),")
                    a445= mylist[j]
                ...
                if f'PRIMARY KEY (`{c10_at1}`)' in mylist[j]:
                    mylist[j] = (f"PRIMARY KEY (`{c10_at1_0}`)")
                    a446= mylist[j]
                    file_object.write(a446)
                    file_object.write("\n")
                ...
                if f'KEY `FK_{assoc6}_{c4_at3}_idx` (`{c4_at3}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc6_0}_{c4_at3_0}_idx` (`{c4_at3_0}`),'")
                    a447= mylist[j]
                    file_object.write(a447)
                    file_object.write("\n")

                if f'KEY `FK_{class4_name}_{c10_at1}_idx` (`{c10_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{class4_name_0}_{c10_at1_0}_idx` (`{c10_at1_0}`),")
                    a448= mylist[j]
                    file_object.write(a448)
                    file_object.write("\n")

                if f'CREATE TABLE `{class9_name}` (' in mylist[j]:
                    mylist[j] = (f"CREATE TABLE `{class9_name_0}` (")
                    a449= mylist[j]
                    file_object.write(a449)
                    file_object.write("\n")


                if f'ADD CONSTRAINT `FK_{class2_name}_{c10_at1}` FOREIGN KEY (`{c10_at1}`) REFERENCES `{class10_name}` (`{c10_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{class2_name_0}_{c10_at1_0}` FOREIGN KEY (`{c10_at1_0}`) REFERENCES `{class10_name_0}` (`{c10_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a450= mylist[j]
                    file_object.write(a450)
                    file_object.write("\n")


                if f'ADD CONSTRAINT `FK_{class3_name}_{c10_at1}` FOREIGN KEY (`{c10_at1}`) REFERENCES `{class10_name}` (`{c10_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{class3_name_0}_{c10_at1_0}` FOREIGN KEY (`{c10_at1_0}`) REFERENCES `{class10_name_0}` (`{c10_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a451= mylist[j]
                    file_object.write(a451)
                    file_object.write("\n")
                ...
                if f'ADD CONSTRAINT `FK_{assoc7}_{c3_at1}` FOREIGN KEY (`{c3_at1}`) REFERENCES `{class3_name}` (`{c3_at1}`) ON DELETE CASCADE ON UPDATE CASCADE,' in mylist[j]:
                    ...
                    a452= mylist[j]
                    file_object.write(a452)
                    file_object.write("\n")

                if f'ADD CONSTRAINT `FK_{assoc7}_{c1_at1}` FOREIGN KEY (`{c1_at1}`) REFERENCES `{class1_name}` (`{c1_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{assoc7_0}_{c1_at1_0}` FOREIGN KEY (`{c1_at1_0}`) REFERENCES `{class1_name_0}` (`{c1_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a453= mylist[j]
                    file_object.write(a453)
                    file_object.write("\n")

                if f'ADD CONSTRAINT `FK_{assoc1}_{c4_at3}` FOREIGN KEY (`{c4_at3}`) REFERENCES `{class4_name}` (`{c4_at3}`) ON DELETE CASCADE ON UPDATE CASCADE,' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{assoc1_0}_{c4_at3_0}` FOREIGN KEY (`{c4_at3_0}`) REFERENCES `{class4_name_0}` (`{c4_at3_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a454= mylist[j]
                    file_object.write(a454)
                    file_object.write("\n")


                if f'ADD CONSTRAINT `FK_{assoc4}_{c10_at1}` FOREIGN KEY (`{c10_at1}`) REFERENCES `{class10_name}` (`{c10_at1}`) ON DELETE CASCADE ON UPDATE CASCADE,' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{assoc4_0}_{c10_at1_0}` FOREIGN KEY (`{c10_at1_0}`) REFERENCES `{class10_name_0}` (`{c10_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a455= mylist[j]
                    file_object.write(a455)
                    file_object.write("\n")


                if f'ADD CONSTRAINT `FK_{assoc4}_{c6_at2}` FOREIGN KEY (`{c6_at2}`) REFERENCES `{class6_name}` (`{c6_at2}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{assoc4_0}_{c6_at2_0}` FOREIGN KEY (`{c6_at2_0}`) REFERENCES `{class6_name_0}` (`{c6_at2_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a456= mylist[j]
                    file_object.write(a456)
                    file_object.write("\n")
                ...
                if f'ADD CONSTRAINT `FK_{assoc5}_{c1_at1}` FOREIGN KEY (`{c1_at1}`) REFERENCES `{class1_name}` (`{c1_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{assoc5_0}_{c1_at1_0}` FOREIGN KEY (`{c1_at1_0}`) REFERENCES `{class1_name_0}` (`{c1_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a457= mylist[j]
                    file_object.write(a457)
                    file_object.write("\n")


                if f'ADD CONSTRAINT `FK_{assoc6}_{c4_at3}` FOREIGN KEY (`{c4_at3}`) REFERENCES `{class4_name}` (`{c4_at3}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{assoc6_0}_{c4_at3_0}` FOREIGN KEY (`{c4_at3_0}`) REFERENCES `{class4_name_0}` (`{c1_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a458= mylist[j]
                    file_object.write(a458)
                    file_object.write("\n")


                if f'ADD CONSTRAINT `FK_{class4_name}_{c10_at1}` FOREIGN KEY (`{c10_at1}`) REFERENCES `{class10_name}` (`{c10_at1}`) ON DELETE CASCADE ON UPDATE CASCADE,' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{class4_name_0}_{c10_at1_0}` FOREIGN KEY (`{c10_at1_0}`) REFERENCES `{class10_name_0}` (`{c10_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a459= mylist[j]
                    file_object.write(a459)
                    file_object.write("\n")


                if f'ADD CONSTRAINT `FK_{assoc9}_{c3_at1}` FOREIGN KEY (`{c3_at1}`) REFERENCES `{class3_name}` (`{c3_at1}`) ON DELETE CASCADE ON UPDATE CASCADE,' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{assoc9_0}_{c3_at1_0}` FOREIGN KEY (`{c3_at1_0}`) REFERENCES `{class3_name_0}` (`{c3_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a460= mylist[j]
                    file_object.write(a460)
                    file_object.write("\n")


                if f'ADD CONSTRAINT `FK_{assoc9}_{c2_at1}` FOREIGN KEY (`{c2_at1}`) REFERENCES `{class2_name}` (`{c2_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{assoc9_0}_{c2_at1_0}` FOREIGN KEY (`{c2_at1_0}`) REFERENCES `{class2_name_0}` (`{c2_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a461= mylist[j]
                    file_object.write(a461)
                    file_object.write("\n")
                ...
                if f'ALTER TABLE `{class9_name}`' in mylist[j]:
                    ...
                    a462 = mylist[j]
                    file_object.write(a462)
                    file_object.write("\n")

                if f'ADD CONSTRAINT `FK_{class9_name}_{c2_at1}` FOREIGN KEY (`{c2_at1}`) REFERENCES `{class2_name}` (`{c2_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{class9_name_0}_{c2_at1_0}` FOREIGN KEY (`{c2_at1_0}`) REFERENCES `{class2_name_0}` (`{c2_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a463= mylist[j]
                    file_object.write(a463)
                    file_object.write("\n")



                if f'`{c5_at1}` {c5_at1_type} NOT NULL,' in mylist[j]:
                    mylist[j] = (f"`{c5_at1_0}` {c5_at1_type_0} NOT NULL,")
                    a464 = mylist[j]
                    file_object.write(a464)
                    file_object.write("\n")


                if f'KEY `FK_{assoc4}_{c5_at1}_idx` (`{c5_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc4_0}_{c5_at1_0}_idx` (`{c5_at1_0}`),")
                    a465 = mylist[j]
                    file_object.write(a465)
                    file_object.write("\n")

                if f'KEY `FK_{assoc4}_{c3_at1}_idx` (`{c3_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc4_0}_{c3_at1_0}_idx` (`{c3_at1_0}`),")
                    a466 = mylist[j]
                    file_object.write(a466)
                    file_object.write("\n")

                if f'PRIMARY KEY (`{c5_at1}`,`{c3_at1}`)' in mylist[j]:
                    mylist[j] = (f"PRIMARY KEY (`{c5_at1_0}`,`{c3_at1_0}`)")
                    a467 = mylist[j]
                    file_object.write(a467)
                    file_object.write("\n")
                ...
                if f'`{c3_at1}` {c3_at1_type},' in mylist[j]:
                    ...
                    a469 = mylist[j]
                    file_object.write(a469)
                    file_object.write("\n")

                if f'`{c4_at1}` {c4_at1_type},' in mylist[j]:
                    mylist[j] = (f"`{c4_at1_0}` {c4_at1_type_0},")
                    a470 = mylist[j]
                    file_object.write(a470)
                    file_object.write("\n")

                if f'`{c6_at1}` {c6_at1_type},' in mylist[j]:
                    mylist[j] = (f"`{c6_at1_0}` {c6_at1_type_0},")
                    a472 = mylist[j]
                    file_object.write(a472)
                    file_object.write("\n")

                if f'`{c6_at1}` {c6_at1_type} NOT NULL,' in mylist[j]:
                    mylist[j] = (f"`{c6_at1_0}` {c6_at1_type_0} NOT NULL,")
                    a473 = mylist[j]
                    file_object.write(a473)
                    file_object.write("\n")
                ...
                if f'PRIMARY KEY (`{c4_at1}`)' in mylist[j]:
                    ...
                    a476 = mylist[j]
                    file_object.write(a476)
                    file_object.write("\n")

                if f'KEY `FK_{class4_name}_{c6_at1}_idx` (`{c6_at1}`),' in mylist[j]:
                    mylist[j] = (f"FK_{class4_name_0}_{c6_at1_0}_idx` (`{c6_at1_0}`),")
                    a477 = mylist[j]
                    file_object.write(a477)
                    file_object.write("\n")
                ...
                if f'`{c3_at2}` {c3_at2_type}(64),' in mylist[j]:
                    ...
                    a479 = mylist[j]
                    file_object.write(a479)
                    file_object.write("\n")



                if f'KEY `FK_{class3_name}_{c6_at1}_idx` (`{c6_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{class3_name_0}_{c6_at1_0}_idx` (`{c6_at1_0}`),")
                    a480 = mylist[j]
                    file_object.write(a480)
                    file_object.write("\n")

                if f'KEY `FK_{assoc3}_{c4_at1}_idx` (`{c4_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc3_0}_{c4_at1_0}_idx` (`{c4_at1_0}`),")
                    a481 = mylist[j]
                    file_object.write(a481)
                    file_object.write("\n")


                if f'PRIMARY KEY (`{c4_at1}`,`{c3_at1}`)' in mylist[j]:
                    mylist[j] = (f"PRIMARY KEY (`{c4_at1_0}`,`{c3_at1_0}`)")
                    a482 = mylist[j]
                    file_object.write(a482)
                    file_object.write("\n")
                ...
                if f'KEY `FK_{class7_name}_{c5_at1}_idx` (`{c5_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{class7_name_0}_{c5_at1_0}_idx` (`{c5_at1_0}`),")
                    a483 = mylist[j]
                    file_object.write(a483)
                    file_object.write("\n")
                ...
                if f'KEY `FK_{assoc5}_{c3_at1}_idx` (`{c3_at1}`),' in mylist[j]:
                    ...
                    a484 = mylist[j]
                    file_object.write(a484)
                    file_object.write("\n")


                if f'ADD CONSTRAINT `FK_{assoc4}_{c5_at1}` FOREIGN KEY (`{c5_at1}`) REFERENCES `{class5_name}` (`{c5_at1}`) ON DELETE CASCADE ON UPDATE CASCADE,' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{assoc4_0}_{c5_at1_0}` FOREIGN KEY (`{c5_at1_0}`) REFERENCES `{class5_name_0}` (`{c5_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE,")
                    a485 = mylist[j]
                    file_object.write(a485)
                    file_object.write("\n")
                ...
                if f'ADD CONSTRAINT `FK_{assoc4}_{c3_at1}` FOREIGN KEY (`{c3_at1}`) REFERENCES `{class3_name}` (`{c3_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{assoc4_0}_{c3_at1_0}` FOREIGN KEY (`{c3_at1_0}`) REFERENCES `{class3_name_0}` (`{c3_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE,")
                    a486 = mylist[j]
                    file_object.write(a486)
                    file_object.write("\n")


                if f'ADD CONSTRAINT `FK_{class4_name}_{c6_at1}` FOREIGN KEY (`{c6_at1}`) REFERENCES `{class6_name}` (`{c6_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{class4_name_0}_{c6_at1_0}` FOREIGN KEY (`{c6_at1_0}`) REFERENCES `{class6_name_0}` (`{c6_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a487 = mylist[j]
                    file_object.write(a487)
                    file_object.write("\n")
                ...
                if f'ADD CONSTRAINT `FK_{class3_name}_{c6_at1}` FOREIGN KEY (`{c6_at1}`) REFERENCES `{class6_name}` (`{c6_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{class3_name_0}_{c6_at1_0}` FOREIGN KEY (`{c6_at1_0}`) REFERENCES `{class6_name_0}` (`{c6_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a488 = mylist[j]
                    file_object.write(a488)
                    file_object.write("\n")
                ...
                if f'ADD CONSTRAINT `FK_{assoc3}_{c4_at1}` FOREIGN KEY (`{c4_at1}`) REFERENCES `{class4_name}` (`{c4_at1}`) ON DELETE CASCADE ON UPDATE CASCADE,' in mylist[j]:
                    ...
                    a492 = mylist[j]
                    file_object.write(a492)
                    file_object.write("\n")


                if f'ADD CONSTRAINT `FK_{class7_name}_{c5_at1}` FOREIGN KEY (`{c5_at1}`) REFERENCES `{class5_name}` (`{c5_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{class7_name_0}_{c5_at1_0}` FOREIGN KEY (`{c5_at1_0}`) REFERENCES `{class5_name_0}` (`{c5_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a493 = mylist[j]
                    file_object.write(a493)
                    file_object.write("\n")
                ...
                if f'`{c2_at1}` {c2_at1_type},' in mylist[j]:
                    ...
                    a494 = mylist[j]
                    file_object.write(a494)
                    file_object.write("\n")


                if f'KEY `FK_{class1_name}_{c3_at1}_idx` (`{c3_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{class1_name_0}_{c3_at1_0}_idx` (`{c3_at1_0}`),")
                    a496 = mylist[j]
                    file_object.write(a496)
                    file_object.write("\n")
                ...
                if f'KEY `FK_{class1_name}_{c3_at1}_idx` (`{c3_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{class1_name_0}_{c3_at1_0}_idx` (`{c3_at1_0}`),")
                    a497 = mylist[j]
                    file_object.write(a497)
                    file_object.write("\n")




                if f'KEY `FK_{assoc1}_{c6_at1}_idx` (`{c6_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc1_0}_{c6_at1_0}_idx` (`{c6_at1_0}`),")
                    a498 = mylist[j]
                    file_object.write(a498)
                    file_object.write("\n")


                if f'KEY `FK_{class2_name}_{c5_at1}_idx` (`{c5_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{class2_name_0}_{c5_at1_0}_idx` (`{c5_at1_0}`),")
                    a499 = mylist[j]
                    file_object.write(a499)
                    file_object.write("\n")


                if f'KEY `FK_{assoc1}_{c4_at1}_idx` (`{c4_at1}`),' in mylist[j]:
                    mylist[j] = (f"KEY `FK_{assoc1_0}_{c4_at1_0}_idx` (`{c4_at1_0}`),")
                    a500 = mylist[j]
                    file_object.write(a500)
                    file_object.write("\n")
                ...
                if f'PRIMARY KEY (`{c6_at1}`,`{c4_at1}`)' in mylist[j]:
                    mylist[j] = (f"PRIMARY KEY (`{c6_at1_0}`,`{c4_at1_0}`)")
                    a501 = mylist[j]
                    file_object.write(a501)
                    file_object.write("\n")


                if f'ADD CONSTRAINT `FK_{class1_name}_{c3_at1}` FOREIGN KEY (`{c3_at1}`) REFERENCES `{class3_name}` (`{c3_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{class1_name_0}_{c3_at1_0}` FOREIGN KEY (`{c3_at1_0}`) REFERENCES `{class3_name_0}` (`{c3_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE,")
                    a502 = mylist[j]
                    file_object.write(a502)
                    file_object.write("\n")


                if f'ADD CONSTRAINT `FK_{class2_name}_{c5_at1}` FOREIGN KEY (`{c5_at1}`) REFERENCES `{class5_name}` (`{c5_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{class2_name_0}_{c5_at1_0}` FOREIGN KEY (`{c5_at1_0}`) REFERENCES `{class5_name_0}` (`{c5_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE;")
                    a503 = mylist[j]
                    file_object.write(a503)
                    file_object.write("\n")



                if f'ADD CONSTRAINT `FK_{assoc1}_{c6_at1}` FOREIGN KEY (`{c6_at1}`) REFERENCES `ProcessStaff` (`{c6_at1}`) ON DELETE CASCADE ON UPDATE CASCADE,' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{assoc1_0}_{c6_at1_0}` FOREIGN KEY (`{c6_at1_0}`) REFERENCES `{assoc1_0}` (`{c6_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE,")
                    a504 = mylist[j]
                    file_object.write(a504)
                    file_object.write("\n")

                if f'ADD CONSTRAINT `FK_{assoc1}_{c4_at1}` FOREIGN KEY (`{c4_at1}`) REFERENCES `ProcessStaff` (`{c4_at1}`) ON DELETE CASCADE ON UPDATE CASCADE;' in mylist[j]:
                    mylist[j] = (f"ADD CONSTRAINT `FK_{assoc1_0}_{c4_at1_0}` FOREIGN KEY (`{c4_at1_0}`) REFERENCES `{assoc1_0}` (`{c4_at1_0}`) ON DELETE CASCADE ON UPDATE CASCADE")
                    a505 = mylist[j]
                    file_object.write(a505)
                    file_object.write("\n")
