-- CREATE DATABASE FOR /home/centos/orm_synthesizer/models/traffic_control/ImplSolution/traffic_control_Sol_3629.sql

USE traffic_control_Sol_3629;
--
...
--
-- Table structure for table TARSInsurance_CompanyAssociation
--

CREATE TABLE `TARSInsurance_CompanyAssociation` (
`TARS_NO` int NOT NULL, 
`Policy_No` int NOT NULL, 
KEY `FK_TARSInsurance_CompanyAssociation_TARS_NO_idx` (`TARS_NO`),
KEY `FK_TARSInsurance_CompanyAssociation_Policy_No_idx` (`Policy_No`),
PRIMARY KEY (`TARS_NO`,`Policy_No`)
);
...
--
-- Table structure for table Insurance_CompanyGISAssociation
--

CREATE TABLE `Insurance_CompanyGISAssociation` (
`Policy_No` int NOT NULL, 
`GISRoute` int NOT NULL, 
KEY `FK_Insurance_CompanyGISAssociation_Policy_No_idx` (`Policy_No`),
KEY `FK_Insurance_CompanyGISAssociation_GISRoute_idx` (`GISRoute`),
PRIMARY KEY (`Policy_No`,`GISRoute`)
);
...
`EmployeeId` int NOT NULL, 
KEY `FK_Insurance_EmployeeId_idx` (`EmployeeId`),
PRIMARY KEY (`EmployeeId`)
);
...
ALTER TABLE `TARSInsurance_CompanyAssociation`
  ADD CONSTRAINT `FK_TARSInsurance_CompanyAssociation_TARS_NO` FOREIGN KEY (`TARS_NO`) REFERENCES `TARS` (`TARS_NO`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_TARSInsurance_CompanyAssociation_Policy_No` FOREIGN KEY (`Policy_No`) REFERENCES `Insurance_Company` (`Policy_No`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `Insurance_CompanyGISAssociation`
  ADD CONSTRAINT `FK_Insurance_CompanyGISAssociation_Policy_No` FOREIGN KEY (`Policy_No`) REFERENCES `Insurance_Company` (`Policy_No`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_Insurance_CompanyGISAssociation_GISRoute` FOREIGN KEY (`GISRoute`) REFERENCES `GIS` (`GISRoute`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `Insurance`
  ADD CONSTRAINT `FK_Insurance_EmployeeId` FOREIGN KEY (`EmployeeId`) REFERENCES `Traffic_Controller` (`EmployeeId`) ON DELETE CASCADE ON UPDATE CASCADE;
